...
section Main things
Preparar PG01:active,first_1,2023-04-15,3d
Entrega PG01:first_2,2023-04-18,1d

section PG01
Diagrama de Gantt:active, first_1, 2023-04-15, 12h
Delimitar tema: active, first_2, after first_1, 12h
...
datos = encuesta[encuesta$MainBranch != "None of these" & complete.cases(encuesta$ConvertedCompYearly),]
...
| Sexuality             | Categórica Nominal | Sexo del desarrollador                                             |
...
| numberOfJobs          | Numérica continua  | Número de trabajos relacionados al lenguaje de programación       |
| numberOfUsers         | Numérica continua  | Número de usuarios que usan el lenguaje                           |
