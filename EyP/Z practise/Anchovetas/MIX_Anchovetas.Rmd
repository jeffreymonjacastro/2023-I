...
seleccionar las posiciones 1 y 5 del vector b
seleccionar los elementos que sean 'Serena' 'Diana' y 'Solymar' del vector b

Formas de seleccionar la variable Largo del dataframe DF

inspeccionar los comando colSums rowSums
Diferencia entre is.na y complete.cases

Probar comandos dplyr
