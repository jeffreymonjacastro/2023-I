...
La variable es sesgada a la derecha. La clase modal es [0, 1000].

Calcule la tasa mortalidad de cada día como el cociente del acumulado del número de muertos entre el acumulado del número de contagiados, ambos para ese día, como porcentaje. Guarde la variable en la columna `TMA`. 
