...
Esto se debe a la naturaleza misma del _checkbox_; está marcado (`TRUE`) o no está marcado (`FALSE`), el `NA` debería ser imposible, pero los usuarios siempre son muy _astutos_ y si uno simplemente borra la celda, el resultado es `NA`.
